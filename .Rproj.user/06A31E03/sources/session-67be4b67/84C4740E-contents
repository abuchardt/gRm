#' Compute gamma polynomials (recursive formula)
#'
#' This function computes gamma polynomials for Rasch models
#' without local dependence.
#'
...
#' @export
#'
SGamma <- memoise::memoise(function(pars, r, par.grp){
